  ...
  <div class="md-layout">
    <div class="md-layout-item">
      <md-card>
        <md-card-header class="md-card-header-icon md-card-header-green">
          ...
          <h4 class="title">Solicitudes de soportes</h4>
        </md-card-header>
        <md-card-content>
          <md-table
            :value="queriedData"
          ...
          >
            ...
            <md-table-row slot="md-table-row" slot-scope="{ item }">
              ...
              <md-table-cell md-label="EMPRESA">{{ item.empresa }}</md-table-cell>
              <md-table-cell md-label="ACCIONES">
                ...
                <router-link :to="{name:'SOLICITUD DE SOPORTE', params:{id:item._id}}">
                  <md-button
    ...
    <modal v-if="noticeModal" @close="noticeModalHide" footer-classes="justify-content-center"   type="notice">
                ...
                <template slot="footer" >
                  <router-link :to="{name:'SOLICITUD DE SOPORTE', params:{id:miSolicitud._id}}">
